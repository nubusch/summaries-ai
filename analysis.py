...
ImageNormalizer = Executor.from_hub("jinahub://ImageNormalizer")
ChunkSentencizer = Executor.from_hub("jinahub://ChunkSpacySentencizer")
...
flow = (
    Flow()
    .add(uses=PDFSegmenter, name="segmenter")
